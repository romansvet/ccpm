...
class DirectoryMerger:
    ...
    def merge_directories(self, source: Path, target: Path, update_mode: bool = False) -> None:
        ...
        for rel_path in source_files:
            ...
            if should_copy:
                ...
                if src_file.is_file():
                    ...
                    print(f"  {'Updated' if tgt_file.exists() else 'Added'}: {rel_path}")
    ...
    def _should_copy_file(self, rel_path: Path, target_file: Path, update_mode: bool) -> bool:
